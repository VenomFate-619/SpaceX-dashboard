        ...
        <div className={styles.cardBody}>
          ...
          <div className={styles.icons}>
            <div className={styles.status}>
              {/* success */}
              <ToolTip text={success ? "Misson Successfull" : "Misson Failed"}>
                <svg
            ...
            <div className={styles.fairing}>
              {/* fairing */}
              <ToolTip
                text={recovered ? "Fairing recovered" : "Fairing not recovered"}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
            ...
            <div className={styles.booster}>
              {/* booster */}
              <ToolTip
                text={landingSuccess ? "Booster landed" : "Booster not landed"}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
